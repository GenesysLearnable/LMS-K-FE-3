				...
				<section>
					<div class="mt-10 flex flex-col items-center justify-center">
						<div class="flex gap-x-28 w-[1034px]">
							<div class="space-y-5">
								<p class="text-5xl font-bold text-[#130E5D]">
									Learning can be hard <br /> we make it{" "}
									<span class="text-[#FF6A00]">fun!</span>
								</p>
								<p class="text-base text-[#04031C]">
								...
								<div class="flex flex-col items-center justify-center">
									<button
										type="button"
										class="text-xl text-white bg-white bg-[#130E5D] rounded-md p-3"
									>
										Get started
									</button>
								</div>
				...
				<section>
					<div class="flex flex-col items-center justify-center">
						<div class="flex gap-x-28 h-screen items-center w-[1034px]">
							...
							<div class="space-y-5">
								<h1 class="text-5xl font-bold text-[#130E5D]">
									Learning to read through <br />{" "}
									<span class="text-[#FF6A00]">play</span>
								</h1>
								<p class="text-base text-[#04031C]">
						...
						<div class="flex gap-x-28 h-screen items-center w-[1034px]">
							<div class="space-y-5">
								<h1 class="text-5xl font-bold text-[#130E5D]">
									...
									<span class="text-[#FF6A00]">games</span>
								</h1>
								<p class="text-base text-[#04031C]">
				...
				<section class="flex justify-center">
					<div class="flex justify-center gap-x-10 w-[1034px]">
						<div className="text-center shadow-lg py-10 rounded-xl my-10 flex flex-col items-center w-1/4">
							<img src={phonics} alt="" />
							<div>
								<h1 class="text-[45px] font-bold text-[#130E5D]">
									Phonics
								</h1>
								<p class="text-[#04031C]">
					...
					<div class="flex flex-col items-center justify-center">
						<div class="flex gap-x-28 items-center w-[1034px]">
							<div class="space-y-5">
								<h1 class="text-5xl font-bold text-[#130E5D]">
									We have a
									<span class="text-[#FF6A00]"> vision</span>
								</h1>
								<p class="text-[#04031C]">
